...
class SevenScenesLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        scene_dir = f"{self.dataset_path}/{scene_name}/{scene_name}/seq-{seq_id:02d}/seq-{seq_id:02d}/" if scene_name == 'fire' else f"{self.dataset_path}/{scene_name}/seq-{seq_id:02d}/"
